#!/bin/bash -l
#SBATCH --job-name=sharsa_humanoid_1b
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -p smallgpu
#SBATCH --gres=gpu:1
#SBATCH -o /scratch/gautschi/manors/logs/sharsa_humanoid_1b_%j.out
#SBATCH -e /scratch/gautschi/manors/logs/sharsa_humanoid_1b_%j.err
...
python main.py \
  --run_group=paper_sharsa_humanoid_1b \
  --seed=0 \
