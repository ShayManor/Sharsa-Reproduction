#!/bin/bash -l
#SBATCH --job-name=sharsa_humanoid_100m
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -p smallgpu
#SBATCH --gres=gpu:1
#SBATCH -o /scratch/gautschi/manors/logs/sharsa_humanoid_100m_%j.out
#SBATCH -e /scratch/gautschi/manors/logs/sharsa_humanoid_100m_%j.err
...
python main.py \
  --run_group=paper_sharsa_humanoid_100m \
  --seed=0 \
