#!/bin/bash -l
#SBATCH --job-name=sharsa_p46_100m
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -p smallgpu
#SBATCH --gres=gpu:1
#SBATCH -o /scratch/gautschi/manors/logs/sharsa_p46_100m_%j.out
#SBATCH -e /scratch/gautschi/manors/logs/sharsa_p46_100m_%j.err
...
python main.py \
  --run_group=paper_sharsa_p46_100m \
  --seed=0 \
  --env_name=puzzle-4x6-play-oraclerep-v0 \
  --dataset_dir="$BASE/puzzle-4x6-play-100m-v0" \
