#!/bin/bash -l
#SBATCH --job-name=sharsa_cube_1b
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -p smallgpu
#SBATCH --gres=gpu:1
#SBATCH -o /scratch/gautschi/manors/logs/sharsa_cube_1b_%j.out
#SBATCH -e /scratch/gautschi/manors/logs/sharsa_cube_1b_%j.err
...
python main.py \
  --run_group=paper_sharsa_cube_1b \
  --seed=0 \
  --env_name=cube-octuple-play-oraclerep-v0 \
  --dataset_dir="$BASE/cube-octuple-play-1b-v0" \
