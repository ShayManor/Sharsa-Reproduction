...
#SBATCH -p smallgpu
#SBATCH --gres=gpu:1
#SBATCH -o /scratch/gautschi/manors/logs/sharsa_p46_1b_%j.out
#SBATCH -e /scratch/gautschi/manors/logs/sharsa_p46_1b_%j.err
